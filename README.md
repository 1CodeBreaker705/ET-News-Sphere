...
- **AI Core**: Google **Gemini 3.1 Flash Lite** (Flagship Preview) & **Google GenAI SDK**.
- **Memory Layer**: 100% Cloud-Powered Intelligence via **Google GenAI API** (`text-embedding-004`). 3072-dimensional vector space for maximum semantic precision. No local models or heavy dependencies.
...
# Tip: If migrating from older versions, use --force-reinstall
